...
int ManagerServer::getWorldWidth()
{
    return WorldWidth;
}

Menu* ManagerServer::getMenu()
{
	return menu;
}

Wall* ManagerServer::getWall()
{
    return wall;
}

Obstacles* ManagerServer::getObs()
{
    return obs;
}

Bomberman* ManagerServer::getBomber1()
{
    return bomber1;
}

Bomberman* ManagerServer::getBomber2()
{
    return bomber2;
}

Bomb* ManagerServer::getBomb()
{
    return bomb1;
}
Gift* ManagerServer::getGift()
{
	return gift;
}
